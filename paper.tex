...
In the field of traffic management and prediction                     % management? Prediction? Traffic what? Rate? modelling? 
...
Sometimes either no data in a suitable format is available or incomplete data makes unable solving the problem at hand. 
In other cases, confidentiality of commercial data reduces the availability of data to a few researchers. 
This limits the access to data and reproducibility of results.
...
However, in other areas there is a need for this type of real problems, such as in the area of traffic management and prediction.
